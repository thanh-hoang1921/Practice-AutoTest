			...
			case 2: 
				if ((year % 4 == 0 && year % 100 != 0) || year %400 == 0) {
					if (day > 29) {
						...
						System.out.println("Month " + month + " of year " + year + " has 29 days and year " + year + " is a leap year" );
						System.out.println(day + "/" + month + "/" + year + " is valid");
					}
				} else {
					if(day > 28) {
						...
						System.out.println("Month " + month + " of year " + year + " has 28 days and year " + year + " isn't a leap year" );
						System.out.println(day + "/" + month + "/" + year + " is valid");
					}
				}
				break;

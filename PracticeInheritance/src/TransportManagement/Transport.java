...
public abstract class Transport {
	...
	public String toString() {
	  ...
	  System.out.println("Input vehical color: "); color = scanner.nextLine();
	  System.out.println("Input vehical owner: "); owner = scanner.nextLine();
	 // System.out.println("Input vehical type: "); vehicalType = scanner.nextLine();
	  }
	  ...
	  public boolean isYearOfManufactureValid() {
		  ...
		  if (isNumberValid()) { 
			  int year = Integer.parseInt(yearOfManufacture); if (year <= currentYear && year > 2000)
				  return true; 
		  } 
		  return false; 
	  }
